...
plot_graph <- function(graph) {
    ...
    layout_custom <- layout_nicely(graph)
...
local_search_correct <- function(elist, objective, n_iter=3) {
...
handle_mislabels_correct_main_with_remove_majority <- function(elist, n_iter=3, max_subjects=9, n_set=10) {
    ...
    while (curr_set < n_set) {
        ...
        elist <- handle_mislabels_correct_local_search_entropy(elist, n_iter=2)
        curr_set <- curr_set + 1
    }
